 ...
 */
@Entity
@Table(name="Chat_History_Details")
public class ChatHistoryDetails {
	...
	public ChatHistoryDetails(Long id, String fromUserId, String toUserId, String fromEmpId, String toEmpId,
			String remarks, String message, String docId, Boolean isActive, String createdBy, Date createdDate,
			String modifiedBy, Date modifiedDate, String chatId) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ChatHistoryDetails [id=" + id + ", fromUserId=" + fromUserId + ", toUserId=" + toUserId + ", fromEmpId="
				...
				+ ", modifiedBy=" + modifiedBy + ", modifiedDate=" + modifiedDate + ", chatId=" + chatId + "]";
	}
